...
const AddExistingSite = () => {
    ...
    const validateForm = () => {
        ...
        if (!formData.siteName.trim()) {
            newErrors.siteName = "Existing site name is required";
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (decryptedResponse.status === 200) {
                alert("Existing site added successfully");
                window.history.back();
            } else {
                setErrors({
                    ...errors,
                    submit: decryptedResponse.message || "Failed to add existing site"
                });
            }
        } catch (error) {
            console.error("Error:", error);
            let errorMessage = "Failed to add existing site. Please try again.";
                ...
                <Box sx={{
                    ...
                    <Box>
                        ...
                        <Typography variant="body2" color="text.secondary">
                            Fill in all required fields to add an existing site
                        </Typography>
                    </Box>
                </Box>
                ...
                >
                    <Box sx={{ p: 4 }}>
                        <Grid container spacing={3}>
                            ...
                            <Grid item xs={12} md={6}>
                                <Box data-field="information">
                                    <TextField
                                        fullWidth
                                        label="Existing Site Information"
                                    ...
                                    <Box sx={{ height: '100%' }}>
                                        <Box
                                            sx={{
                                                ...
                                                '&:hover': {
                                                    borderColor: errors.photo ? '#d32f2f' : '#4CAF50',
                                        ...
                                        >
                                            ...
                                            <label htmlFor="site-photo-upload" style={{ cursor: 'pointer' }}>
                                                <Box sx={{
                                                    ...
                                                    <CloudUploadIcon sx={{
                                                        fontSize: 40,
                                                        color: errors.photo ? '#d32f2f' : '#4CAF50',
                                                    ...
                                                    <Typography
                                                        ...
                                                        sx={{ textAlign: 'center' }}
                                                    >
                                                        {selectedFile ? 'Change photo' : 'Click to upload existing site photo'}
                                                    </Typography>
                        ...
                        >
                            ...
                            >
                                {loading ? "Adding Existing Site..." : "Add Existing Site"}
                            </Button>
                        </Box>
                    </Box>
                </Paper>
...
export default AddExistingSite;